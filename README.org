...
** save-executable
   ...
   * =exit-repl= - [keyword, default T] If non-NIL, the Lisp image
     exits after =init-function= has returned. If NIL, the REPL is
     entered. Some Lisp implementations ignore this option and always
     exit.
