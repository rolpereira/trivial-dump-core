trivial-dump-core is a small, MIT-licensed, wrapper that provides a common interface
...
* Installation using quicklisp
  ...
  First, [[http://www.quicklisp.org/beta/#installation][install quicklisp]]. Then, open your lisp interpreter and type:
...
#+END_SRC
   ...
   In that case you need to set the key =exit-repl= to NIL.
